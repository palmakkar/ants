    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 7
                if self.ant and self.ant.container and not insect.container:
                    self.ant.ant = insect
                    self.ant.ant = self.ant
                elif self.ant and not self.ant.container and insect.container:
                    insect.ant = self.ant
                    place.ant = insect
                elif self.ant and not insect.container:
                    return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place = self.place
        while place != hive:
            if random_or_none(place.bees) and counter < self.max_range and counter > self.min_range:
